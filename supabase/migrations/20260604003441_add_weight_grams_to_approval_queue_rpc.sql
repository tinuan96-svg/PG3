/*
  # Add weight_grams column to get_admin_approval_queue RPC

  Adds the `weight_grams` field to the approval queue response so product
  weight/quantity can be shown alongside the unit column to fully identify
  variant products (e.g. 500 Gram, 1 Kg, 1 Ltr).
*/
