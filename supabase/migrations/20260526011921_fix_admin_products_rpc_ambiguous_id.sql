/*
  # Fix get_admin_products RPC — qualify ambiguous "id" column

  The user_profiles lookup used unqualified "id" which conflicts with
  a PL/pgSQL variable. Qualify it as user_profiles.id.
*/
