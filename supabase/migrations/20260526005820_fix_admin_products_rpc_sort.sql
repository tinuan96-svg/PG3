/*
  # Fix get_admin_products RPC - correct dynamic sort

  Recreates the admin products RPC with proper dynamic ORDER BY
  using a CASE statement instead of format() injection.
*/
